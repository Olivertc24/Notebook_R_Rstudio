...
El objetivo es "pintar con datos". Usaremos `ggplot2` para encontrar patrones visuales en los precios de las casas. **Requisito:** Asegúrate de tener el archivo `data_house_price.csv` en tu carpeta.
