...
En este módulo dejaremos de copiar y pegar código. Aprenderemos a escribir nuestras propias funciones y a controlar el flujo de ejecución. **Requisito:** Asegúrate de tener el archivo `data_house_price.csv` disponible.
