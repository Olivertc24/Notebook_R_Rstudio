...
subtitle: "Caso Práctico: Limpieza y Análisis de Ventas Nike"
author: "Oliver Triveño"
format: live-html
engine: knitr
editor: visual
lang: es
...
## 1. Importación e Inspección (Módulos 1, 4)
...
# 3. Inspección inicial (glimpse o str)
```

## 2. Limpieza de Datos "Wrangling" (Módulo 5)

### Ejercicio 2.1: Estandarización de Texto

La columna Region es un desastre. Hay "bengaluru", "Bangalore", "Hyd", "Hyderabad".

1.  Usa mutate() para convertir toda la columna Region a Título (primera letra mayúscula) usando str_to_title().
...
## 3. Manipulación y Estructuras (Módulos 2, 3, 5)
...
1.  Grafica la evolución del Revenue a lo largo del tiempo (geom_line o geom_smooth).

2.  Separa el gráfico en dos paneles (facetas) según Sales_Channel (Retail vs Online).

```{webr}
# Tu código aquí
```

## 5. Programación Funcional (Módulo 7)
